...
export default async function ApplicationDetailsPage({ params }: ApplicationDetailsPageProps) {
  ...
  if (!application) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-white text-slate-800">
        <div className="text-center space-y-3">
          <p className="text-lg font-medium text-slate-700">Application not found</p>
          <Link
            href="/dashboard"
            className="inline-block px-4 py-2 bg-slate-800 text-white text-sm font-medium rounded-xl shadow hover:bg-slate-900 transition-all"
          >
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 p-4 sm:p-8 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="bg-slate-400/10 border border-slate-200/70 p-6 sm:p-8 rounded-2xl shadow-sm backdrop-blur-md space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 pt-4 border-t border-slate-200/60 text-xs">
          {/* Location */}
          <div className="bg-white/60 border border-slate-200/60 p-3 rounded-xl space-y-1">
      ...
      <div className="">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Notes Card */}
          <div className="bg-slate-400/10 border border-slate-200/70 p-6 rounded-2xl shadow-sm">
            <ApplicationNotes
          ...
          <div className="bg-slate-400/10 border border-slate-200/70 p-6 rounded-2xl shadow-sm space-y-4">
