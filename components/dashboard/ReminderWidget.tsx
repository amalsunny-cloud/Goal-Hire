...
export default function ReminderWidget({
  ...
  if (!reminders) {
    return (
      <div className="py-1">
        <WidgetTitle />
        <p className="rounded-2xl px-4 py-6 text-sm text-slate-500">
          Loading reminders…
        </p>
      </div>
    );
...
function ReminderRow({
  ...
  return (
    <li className="flex items-center gap-2 rounded-xl bg-slate-50 px-3 py-2.5 text-sm font-medium text-slate-700">
      <span
        className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-lg ${tones[tone]}`}
      >
