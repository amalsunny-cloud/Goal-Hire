...
export default function RecentApplications({ applications }: RecentApplicationsProps) {
  ...
  const recent = useMemo(() => {
    ...
    return (
      <div className="rounded-lg py-3">
        <h2 className="font-semibold text-2xl mb-2 tracking-tight">Recent Applications</h2>
  ...
  return (
    <div className="rounded-lg p-5">
      <h2 className="font-semibold text-2xl mb-4 text-gray-600 tracking-tight">Recent Applications</h2>
